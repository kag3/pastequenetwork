...
public class ScoreboardManager {
    ...
    private void updateLines(Player player, Scoreboard board) {
        ...
        if (obj != null) {
            switch (context) {
                case "arena":
                    obj.setDisplayName(PastequeSkyblockPlugin.color("&c&lPasteque &4&lArene"));
                    break;
                case "koth":
                    obj.setDisplayName(PastequeSkyblockPlugin.color("&c&l\u265b &4&lKOTH &c&l\u265b"));
                    break;
                case "dungeon":
                    obj.setDisplayName(PastequeSkyblockPlugin.color("&5&lPasteque &d&lDonjon"));
                    break;
                case "island":
                case "island_visit":
                    obj.setDisplayName(PastequeSkyblockPlugin.color("&a&lPasteque &2&lSkyblock"));
                    break;
                default:
                    obj.setDisplayName(PastequeSkyblockPlugin.color("&2&lPasteque &5&lSkyblock"));
                    break;
    ...
    private void updateKothBoard(Player player, Scoreboard board) {
        ...
        setLine(board, 8,  c("&8  \u25B8 &7Dans la zone: " + (playerInZone ? "&a&lOUI" : "&c&lNON")));
        setLine(board, 7,  "");
