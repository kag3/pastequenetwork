...
import fr.pasteque.skyblockarena.util.EmptyChunkGenerator;
...
public class ArenaWorldService {
    ...
    public ArenaWorldService(PastequeSkyBlockArenaPlugin plugin) {
        this.plugin = plugin;
    }
    ...
    public void initializeArenaWorld() {
        ...
        if (world == null) {
            throw new IllegalStateException("Impossible de créer le monde d'arène");
        }
