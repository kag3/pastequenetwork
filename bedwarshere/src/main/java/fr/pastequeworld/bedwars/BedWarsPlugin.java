...
public class BedWarsPlugin extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        getLogger().info("[Init 3/9] world wiper");
        new WorldWiper(this).wipeOnFirstRun();

        getLogger().info("[Init 4/9] load config/messages/shop");
        ...
        getLogger().info("[Init 5/9] player data + map registry");
        this.playerDataManager = new PlayerDataManager(this);
        this.mapRegistry = new MapRegistry(this);
        this.mapRegistry.load();

        getLogger().info("[Init 6/9] arena/queue");
        this.arenaManager = new ArenaManager(this);
        this.queueManager = new QueueManager(this);

        getLogger().info("[Init 7/9] lobby + npc");
        ...
        getLogger().info("[Init 8/9] scoreboard + tab");
        this.scoreboardManager = new ScoreboardManager(this);
        this.tabManager = new TabManager(this);

        getLogger().info("[Init 9/9] listeners + commands");
        registerListeners();
        registerCommands();
